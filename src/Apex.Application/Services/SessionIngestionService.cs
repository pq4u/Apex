...
public class SessionIngestionService : ISessionIngestionService
{
    ...
    public SessionIngestionService(ISessionRepository sessionRepository, IMeetingRepository meetingRepository,
    ...
    public async Task<List<SessionDto>> IngestSessionsAsync(SessionIngestionRequest request)
    {
